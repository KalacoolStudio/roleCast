...
The system SHALL allow users to create, copy, edit and persist plots through a web editor, including descriptive fields, goals, fixed facts, criteria, stop conditions, typed-turn, call-count and cumulative voice-duration limits, and separate Mastermind, Judge and Reporter prompts. It SHALL reject invalid or oversized definitions and duplicate fact IDs/keys or criterion IDs without partial saves.
